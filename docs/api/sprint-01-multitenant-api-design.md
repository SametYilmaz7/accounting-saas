...
{
  "type": "https://errors.saas-platform.local/tenant-header-missing",
...
{
  "type": "https://errors.saas-platform.local/tenant-header-invalid",
...
{
  "type": "https://errors.saas-platform.local/tenant-not-found",
...
{
  "type": "https://errors.saas-platform.local/tenant-inactive",
...
{
  "type": "https://errors.saas-platform.local/tenant-mismatch",
