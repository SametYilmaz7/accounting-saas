...
This sprint does not include authentication screens, accounting workflows,
billing, subscriptions, OCR, reporting, or document storage.

## 2. Business Context

Each independent accounting office is a tenant.

A tenant may later contain multiple users, roles, customers, invoices,
...
Secrets and sensitive accounting data must not be logged.
