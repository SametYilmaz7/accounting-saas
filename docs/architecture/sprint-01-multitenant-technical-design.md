...
Tenant is the root record used to identify an accounting office.
...
"Samet Muhasebe" -> "samet-muhasebe"

"  ABC   Accounting  " -> "abc-accounting"
...
- AccountingSaaSDbContext: Scoped
...
AccountingSaaS.Infrastructure

The startup project for migration commands will be:

AccountingSaaS.WebApi
...
dotnet ef migrations add InitialTenantFoundation \
  --project src/backend/AccountingSaaS.Infrastructure \
  --startup-project src/backend/AccountingSaaS.WebApi \
